...
{
    UIActionSheet *actionSheet = [[UIActionSheet alloc] initWithTitle:nil delegate:self cancelButtonTitle:@"取消" destructiveButtonTitle:nil otherButtonTitles:@"正方形", @"3:2", @"4:3", @"5:3", @"16:9", nil];
...
- (UIView *) bottomBar
{
    if ( !_bottomBar ) {
        ...
        if ( !_forceQuadCrop ) {
            ...
            [actionsheetButton setTitle:@"裁剪比例" forState:UIControlStateNormal];
...
- (UIButton *) retakeButton
{
    if ( !_retakeButton ) {
        ...
        _retakeButton.titleLabel.font = [UIFont systemFontOfSize:15];
